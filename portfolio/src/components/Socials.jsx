...
const socials = [
  { name: 'GitHub', icon: Github, link: 'https://github.com/oss-aryanroy', color: '#d4b4c4' },
  { name: 'LinkedIn', icon: Linkedin, link: 'https://www.linkedin.com/in/aryan-roy-168987252/', color: '#b48ca0' },
]
